...
// From a stack overflow answer by an annonymous user (hopefully Makyen, which later edited the answers) https://stackoverflow.com/questions/41946007/efficient-and-well-explained-implementation-of-a-quadtree-for-2d-collision-det
